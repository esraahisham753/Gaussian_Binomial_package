...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        x_axis = [0, 1]
        count_0 = self.data.count(0)
        count_1 = self.data.count(1)
        y_axis = [count_0, count_1]
    ...
    def pdf(self, k):
        ...
        comb = n_fact / (k_fact * diff_fact)
        return comb * math.pow(self.p, k) * math.pow(1 - self.p, self.n - k)        
